    ...
    class Student : Person, IComparable<Student>
    {
        ...
        public bool setName(string input)
        {
            ...
            if (!input.All(Char.IsLetter))
            {
                ...
                Console.WriteLine("Name can only consist from letters");
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Student> students = new List<Student>
                {
                  new Student("Adnan","Hodzic","Tuzla","adnan@gmail.com",22),
                  new Student("Armin","Hodzic","Tuzla","anhc1218@gmail.com",34),
                  new Student("Fahrudin","Hodzic","Sarajevo","fahrudin@gmail.com",65),
                  new Student("Dzenan" , "Stlic", "Sarajevo ","dzenan@gmail.com",27),
                  new Student("Ervin ", "Begic","Tuzla", "ervin@gmail.com",32),
